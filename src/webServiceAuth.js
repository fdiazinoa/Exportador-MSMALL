...
class WebServiceAuth {
  ...
  _persistTokenPair(serverName, wsConfig, tokenBody) {
    ...
    const resolvedMallId = claims.mall_id || wsConfig.mallId || wsConfig.authState?.mallId;
    const resolvedLocalId = claims.local_id || wsConfig.localId || wsConfig.authState?.localId;
    ...
    this._persistAuthState(serverName, {
      ...
      mallId: resolvedMallId || undefined,
      localId: resolvedLocalId || undefined,
      tokenType: claims.token_type || undefined,
      scope: claims.scope || undefined,
      jti: claims.jti || undefined,
      lastAuthAt: new Date().toISOString(),
    }, {
      ...(resolvedMallId ? { mallId: resolvedMallId } : {}),
  ...
  async testConnection(serverName) {
    ...
    return {
      ...
      tokenAcquired: !!token,
      resolvedIdentity: {
        mallId: wsConfig.authState?.mallId || wsConfig.mallId || null,
        localId: wsConfig.authState?.localId || wsConfig.localId || null,
      },
    };
  }
}
